...
private $spaces = ["\t", "\n", "\r", "\r\n", " "];
private $articles = ["a", "an", "the", "some"];
private $pronouns = ["i", "me", "you", "he", "him", "himself", "she", "her", "herself", "it",
                        "we","us", "they", "them", "who", "whoever", "what", "something",
                        "someone", "anyone"];
private $demonstratives = ["this", "that", "these", "those"];
private $possessives = ["my", "mine", "your", "yours", "his", "hers", "its", "our", "ours",
                        "their", "theirs", "whose", "own"];
private $interrogatives = ["which", "whichever", "what", "whatever", "whatsoever", "any",
                            "either", "neither", "such", "certain"];
private $quantifiers = ["much", "many", "little", "few", "fewer", "less", "least", "more",
                        "most", "lot", "lots", "plenty", "several", "couple", "bit", "pair",
                        "all", "both", "enough",  "each", "every", "everyone", "everywhere",
                        "everything"];
private $numbers = ["zero", "one", "two", "three", "four", "five", "six", "seven", "eight",
                    "nine", "ten", "first", "second", "third", "fourth", "fifth", "sixth",
                    "seventh", "eighth", "ninth", "tenth", "once", "twice", "half", "double",
                    "triple", "quadruple",
                    "hundred", "thousand", "million", "times", "equals", "subtract",
                    "multiply", "divide", "number", "numbers"];
private $adverbs = ["very", "too", "so", "here", "there", "quite", "almost", "certainly",
                     "even", "then", "whether", "however", "still", "really", "out", "up", 
                     "somewhat", "rather", "fully", "especially", "ago", "ever", "never", "by",
                     "just", "always", "not", "right", "now", "well", "how", "again", "away",
                     "already", "yes", "no", "far", "nearly", "near", "maybe", "possibly"];
private $adjectives = ["same", "other", "different", "only", "great", "good", "bad", "worst",
                        "big", "small", "old", "young", "hard", "soft", "another", "long",
                        "longer", "longest", "short", "shorter", "shortest", "first", "last",
                        "late", "later", "latest", "next", "whole"];
private $prepositions = ["in", "from", "with", "for", "to", "at", "on", "under", "upon",
                            "until", "into", "down", "of", "as", "onto", "over", "through",
                            "around", "about", "off", "after", "beside", "against", "without",
                            "behind"];
private $modals = ["can", "could", "may", "might", "shall", "should", "will", "would", "must"];
private $commonNouns = ["word", "words", "thing", "things", "stuff", "room", "rooms", "floor",
                        "night", "nights", "door", "bed", "beds", "question", "questions",
                        "woman", "women", "man", "men", "boy", "boys", "girl", "girls", "sir", 
                        "mr", "mrs", "ms", "house", "houses", "days", "day", "back", "backs",
                        "way", "ways", "answer", "person", "people", "rest", "side", "inside" ];
private $bodyParts = ["shoulder", "shoulders", "eyes", "eye", "face", "faces", 'body', "bodies"];
private $conjunctions = ["for", "and", "nor", "but" "or", "yet", "so", "after", "although",
                        "as", "because", "before", "if", "once", "since" "than", "though",
                        "till", "until", "when", "whenever", "where", "wherever", "while",
                        "why"];

private $other = ["oh", "hey", "course"];
private $mostCommonVerbs = [
